...
function GetLoadedScaffoldingAssemblyVersion() {
	try {
		return [Microsoft.AspNet.Scaffolding.Core.CodeGenerationServices].Assembly.GetName().Version
	} catch {
		return $null
	}
}
...
if ($ScaffoldingAssemblyVersion -eq $null)
{
	...
	$dllsToLoad = ("Microsoft.AspNet.Scaffolding.Core.dll","Microsoft.AspNet.Scaffolding.VisualStudio.dll")
	foreach($dllFile in $dllsToLoad)
	{
		$dllPath = Join-Path $toolsPath $dllFile
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUHzNsNXhb8muFHwbir7HfAOMI
# Cv2gghUmMIIEmTCCA4GgAwIBAgITMwAAAJ0ejSeuuPPYOAABAAAAnTANBgkqhkiG
...
# mu5J4PcBZW+JC33Iacjmbuqnl84xKf8OxVtc2E0bodj6L54/LlUWa8kTo/0xggSk
# MIIEoAIBATCBkDB5MQswCQYDVQQGEwJVUzETMBEGA1UECBMKV2FzaGluZ3RvbjEQ
# MA4GA1UEBxMHUmVkbW9uZDEeMBwGA1UEChMVTWljcm9zb2Z0IENvcnBvcmF0aW9u
# MSMwIQYDVQQDExpNaWNyb3NvZnQgQ29kZSBTaWduaW5nIFBDQQITMwAAAJ0ejSeu
# uPPYOAABAAAAnTAJBgUrDgMCGgUAoIHGMBkGCSqGSIb3DQEJAzEMBgorBgEEAYI3
# AgEEMBwGCisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEW
# BBRXOO4H3ldqC90ANU6IxlR+OLfvVDBmBgorBgEEAYI3AgEMMVgwVqA8gDoATQBp
# AGMAcgBvAHMAbwBmAHQAIABBAFMAUAAuAE4ARQBUACAAUwBjAGEAZgBmAG8AbABk
# AGkAbgBnoRaAFGh0dHA6Ly93d3cuYXNwLm5ldC8gMA0GCSqGSIb3DQEBAQUABIIB
# AFq3FK5B9QncAqx0uXymPOJ6KjPobPDwj7a3TUHui0nOvk84sy1vPnjnVM6T6Ncq
# 5TTjvP9HUPWYSqWCCowa82xIIJqXJ4+hgCdoFslY4JfvthMYZb3yYF3TMKL/NMeq
# osSb5cFYzB3QgYHGxQqUXCnhf04ThrxpKm0e+4fPGiEpxko+UxT1CAnoxSjNQORW
# NxDJgDzCoIxujZGxOtKUU1XdoAmWNDStU07qvzhqobwZqX14MvoQ7bf5eV05/2GB
# Q5nghoLuSyzWJjsw+GOxoCzpfyA/MDvoNrlSVH/WpVsEXnzJuL4xO+NT2vbw5RTX
# rvvsi9aBz5LZY0mXAqnz4LGhggIfMIICGwYJKoZIhvcNAQkGMYICDDCCAggCAQEw
# gYUwdzELMAkGA1UEBhMCVVMxEzARBgNVBAgTCldhc2hpbmd0b24xEDAOBgNVBAcT
# B1JlZG1vbmQxHjAcBgNVBAoTFU1pY3Jvc29mdCBDb3Jwb3JhdGlvbjEhMB8GA1UE
# AxMYTWljcm9zb2Z0IFRpbWUtU3RhbXAgUENBAgphApJKAAAAAAAgMAkGBSsOAwIa
# BQCgXTAYBgkqhkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0x
# MzAyMTUyMDM5MjVaMCMGCSqGSIb3DQEJBDEWBBSvDMyVYkS44ryvVk3KOy2ovvp8
# LDANBgkqhkiG9w0BAQUFAASCAQCYY6k/hIhnn9Jx2ELYJQNuE+lP70rizIhBc01J
# It6mqUuYDWv3azuNoSsoMbzywelVP0hs+kvFB+SJCPtjipY5V+uDQBTQXyvYBbIc
# sdhbKkJVcbBFREqrSQvwnrVFQShiHVqtNcwzJg3kkwiX/bCeCXngU/Qe2kz+kI35
# AzCfUEx+oME/OLdQ/eTAWYiS+josVLzMXX1zY7wjPNf1jv1R8aMwBl231rM7iBW+
# 7hisdmGdByR1NpggQI5xbzRKKyJvvQZJrOKbidRVlW3eeWGY51J63TAUs+N6Eq9c
# awc8J3yMO4n4ontne0i4L0zn4k+b5yo8K5MXDeyodMk4zfge
